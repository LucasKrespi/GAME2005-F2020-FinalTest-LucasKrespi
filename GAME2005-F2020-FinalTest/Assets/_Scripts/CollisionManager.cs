...
public class CollisionManager : MonoBehaviour
{
    ...
    public static void CheckSphereAABB(CubeBehaviour a, BulletBehaviour b)
    {
            ...
            (a.min.z <= b.max.z && a.max.z >= b.min.z))
        {
            ...
            float penetration = float.MaxValue;
            Vector3 bulletface = Vector3.zero;
    ...
    public static void Push(CubeBehaviour b, CubeBehaviour a)
    {
        if (b.gameObject.GetComponent<RigidBody3D>().bodyType == BodyType.DYNAMIC)
        {
            ...
            {
                b.transform.position = new Vector3(a.transform.position.x, b.transform.position.y +0.05f, a.transform.position.z + (b.size.z + 0.1f));
            }
